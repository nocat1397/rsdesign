    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          {!! Form::open(['method'=>'post','action'=>'UploadController@store', 'files'=>true]) !!}
          <div class="form-group">
            ...
            {!! Form::radio('category_id', $data->id) !!}
          
            @endforeach
            <br>
            {!! Form::file('file') !!}
            <hr>
            {!! Form::submit('Submit', ['class'=>'btn btn-outline-info btn-sm shadow float-right', 'style'=>"z-index: 100; color:#000; border:none; text-decoration:none!important; background:#baff00"]) !!}
